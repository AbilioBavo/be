...
var PaymentsController = function () {
    ...
    var PaymentsController = _classThis = /** @class */ (function () {
        ...
        PaymentsController_1.prototype.initiate = function (orderId, method) {
    ...
    (function () {
        ...
        _initiate_decorators = [(0, common_1.Post)(':orderId/initiate'), openapi.ApiResponse({ status: 201, type: Object })];
