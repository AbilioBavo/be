...
var PaymentsService = function () {
    ...
    var PaymentsService = _classThis = /** @class */ (function () {
        function PaymentsService_1(prisma, mpesaGateway, offlineGateway) {
            this.prisma = prisma;
            this.mpesaGateway = mpesaGateway;
            this.offlineGateway = offlineGateway;
        }
        PaymentsService_1.prototype.initiatePayment = function (orderId, method) {
            return __awaiter(this, void 0, void 0, function () {
                var order, gateway, response, payment;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            gateway = method === enums_1.PaymentMethod.MOBILE_MONEY
                                ? this.mpesaGateway
                                : this.offlineGateway;
                            return [4 /*yield*/, gateway.initiatePayment({
                                    orderId: orderId,
                        ...
                        case 2:
                            ...
                            return [4 /*yield*/, this.prisma.payment.create({
                                    data: {
                                        orderId: orderId,
                                        method: method,
                                        status: response.success ? enums_1.PaymentStatus.PENDING : enums_1.PaymentStatus.FAILED,
                                        amount: order.totalAmount,
                                        currency: 'MZN',
        ...
        PaymentsService_1.prototype.confirmPayment = function (orderId) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                return __generator(this, function (_a) {
