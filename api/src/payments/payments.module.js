...
var mpesa_gateway_1 = require("./gateways/mpesa.gateway");
var offline_gateway_1 = require("./gateways/offline.gateway");
var PaymentsModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            controllers: [payments_controller_1.PaymentsController],
            providers: [payments_service_1.PaymentsService, mpesa_gateway_1.MpesaGateway, offline_gateway_1.OfflineGateway, prisma_service_1.PrismaService],
