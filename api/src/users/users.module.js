...
var fileUpload_service_1 = require("../storage-module/fileUpload.service");
var UsersModule = function () {
    var _classDecorators = [(0, common_1.Module)({
            controllers: [users_controller_1.UsersController],
            providers: [users_service_1.UsersService, prisma_service_1.PrismaService, fileUpload_service_1.FileUploadService],
        })];
